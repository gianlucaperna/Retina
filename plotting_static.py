...
def plot_stuff_static(pcap_path, dict_flow_df, df_unique):
    ...
    try:
        plt.ioff()
        class_dict = {-1 : "Unknown", 0 : "Audio", 1 : "Video", 2 : "FEC Video",3: "Screen Sharing", 4 : "FEC Audio", 5 : "HQ", 6 : "LQ", 7 : "MQ"}
        ...
        packets_per_second, kbps_series, inter_packet_gap_s, inter_rtp_timestamp_gap, len_frame, rtp_timestamp = make_rtp_data(dict_flow_df)
        #Plot stuff
